                        ...
                        <div class="row">
                            <div class="col">
                                <div class="slider-text-info slider-content-center slider-text-center">
                                    <h2 class="e1"><span>Cabo Munchies</span></h2>
                                    <p class="e1">Descubre los mejores sabores de las gomitas</p>
                                    <a href="#menu" class="btn btn-style e1">Ver menú</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="slide-image">
                    ...
                    <div class="container slider-info-content">
                        <div class="row">
                            <div class="col">
                                <div class="slider-text-info slider-content-center slider-text-center">
                                    <h2 class="e1"><span>¿Ya nos conoces?</span></h2>
                                    <p class="e1">
                                        Estamos en Los Cabos
                                    </p>
                                    <a href="#menu" class="btn btn-style e1">Ver menú</a>
                                </div>
                            </div>
                    ...
                    <div class="banner-category">
                        <div class="section-capture">
                            <div class="section-title">
                                <h2>Cabo Munchies</h2>
                                <span class="sub-title">Explora los diferentes sabores que tenemos</span>
                            </div>
                        </div>
                    </div>
