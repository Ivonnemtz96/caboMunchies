                                    ...
                                    <div class="style4-slider-big slick-slider">
                                        <div class="slick-slide">
                                            <a href="img/product-template/creamy/p-1.jpg" class="product-single">
                                                <figure class="zoom" onmousemove="zoom(event)"
                                                    style="background-image: url('img/product-template/creamy/p-1.jpg');">
                                                    <img src="img/product-template/creamy/p-1.jpg" class="img-fluid"
                                                        alt="p-1">
                                                </figure>
                                            </a>
                                        </div>
                                        <div class="slick-slide">
                                            <a href="img/product-template/creamy/p-2.jpg" class="product-single">
                                                <figure class="zoom" onmousemove="zoom(event)"
                                                    style="background-image: url('img/product-template/creamy/p-2.jpg');">
                                                    <img src="img/product-template/creamy/p-2.jpg" class="img-fluid"
                                                        alt="p-2">
                                                </figure>
                                            </a>
                                        </div>
                                        <div class="slick-slide">
                                            <a href="img/product-template/creamy/p-3.jpg" class="product-single">
                                                <figure class="zoom" onmousemove="zoom(event)"
                                                    style="background-image: url('img/product-template/creamy/p-3.jpg');">
                                                    <img src="img/product-template/creamy/p-3.jpg" class="img-fluid"
                                                        alt="p-3">
                                                </figure>
                                            </a>
                                        </div>
                                        <div class="slick-slide">
                                            <a href="img/product-template/creamy/p-4.jpg" class="product-single">
                                                <figure class="zoom" onmousemove="zoom(event)"
                                                    style="background-image: url('img/product-template/creamy/p-4.jpg');">
                                                    <img src="img/product-template/creamy/p-4.jpg" class="img-fluid"
                                                        alt="p-4">
                                                </figure>
                                            </a>
                                        </div>
                                        <div class="slick-slide">
                                            <a href="img/product-template/creamy/p-5.jpg" class="product-single">
                                                <figure class="zoom" onmousemove="zoom(event)"
                                                    style="background-image: url('img/product-template/creamy/p-5.jpg');">
                                                    <img src="img/product-template/creamy/p-5.jpg" class="img-fluid"
                                                        alt="p-5">
                                                </figure>
                                            </a>
                                        </div>
                        ...
                        <div class="product_details_wrap product_details_lr product_details">
                                ...
                                <div class="pro-nprist">
                                    ...
                                    <div class="product-info">
                                        <p><span>🚚</span> Item will be delivered on or before <span
                                                id="ten-days-ahead">Mar 3 2023</span></p>
                                    </div>
                                    <div class="product-info">
                                        <div class="product-sku">
                                            <h6>SKU:</h6>
                                            <span class="variant-sku">abccd-19</span>
                                        </div>
                                    </div>
                                    <div class="product-info">
                            ...
                            <section class="product-description-tab">
                                <div class="product-tab" id="collapse-tab">
                                    ...
                                    <div class="tab">
                                        <a href="#collapse-additional-info" class="tab-title collapsed"
                                            data-bs-toggle="collapse">
                                            <h6 class="tab-name">Additional info</h6>
                                            <span class="tab-icon"><i class="bi bi-plus"></i></span>
                                        </a>
                                        <div class="collapse" id="collapse-additional-info"
                                            data-bs-parent="#collapse-tab">
                                    ...
                                    <div class="tab">
                                        <a href="#collapse-other-content" class="tab-title collapsed"
                                            data-bs-toggle="collapse">
                                            <h6 class="tab-name">Other content</h6>
                                            <span class="tab-icon"><i class="bi bi-plus"></i></span>
                                        </a>
                                        <div class="collapse" id="collapse-other-content"
                                            data-bs-parent="#collapse-tab">
                                    ...
                                    <div class="tab">
                                        <a href="#collapse-reviews" class="tab-title collapsed"
                                            data-bs-toggle="collapse">
                                                        ...
                                                        <div class="spr-summary rte">
                                                            ...
                                                            <span class="spr-summary-actions">
                                                                <a href="#add-review" data-bs-toggle="collapse"
                                                                    class="spr-summary-actions-newreview">Write a
                                                                    review</a>
                                                            </span>
                                                        </div>
                                                        <!-- product-rating end -->
                                                            ...
                                                            <form method="post" class="new-review-form">
                                                                ...
                                                                <fieldset class="spr-form-contact">
                                                                    ...
                                                                    <div class="spr-form-contact-email">
                                                                        <label class="spr-form-label">Email
                                                                            address</label>
                                                                ...
                                                                <fieldset class="spr-form-review">
                                                                    ...
                                                                    <div class="spr-form-review-title">
                                                                        <label class="spr-form-label">Review
                                                                            title</label>
                                                                        <input type="text" name="q"
                                                                            class="spr-form-input spr-form-input-text "
                    ...
                    <div class="insta-slider owl-carousel owl-theme" id="insta-slider">
                        <div class="item">
                            <a href="javascript:void(0)" class="banner-hover">
                                <img src="img/insta/backery-instagram-01.jpg" class="img-fluid"
                                    alt="backery-instagram-01">
                            </a>
                        </div>
                        <div class="item">
                            <a href="javascript:void(0)" class="banner-hover">
                                <img src="img/insta/backery-instagram-02.jpg" class="img-fluid"
                                    alt="backery-instagram-02">
                            </a>
                        </div>
                        <div class="item">
                            <a href="javascript:void(0)" class="banner-hover">
                                <img src="img/insta/backery-instagram-03.jpg" class="img-fluid"
                                    alt="backery-instagram-03">
                            </a>
                        </div>
                        <div class="item">
                            <a href="javascript:void(0)" class="banner-hover">
                                <img src="img/insta/backery-instagram-04.jpg" class="img-fluid"
                                    alt="backery-instagram-04">
                            </a>
                        </div>
                        <div class="item">
                            <a href="javascript:void(0)" class="banner-hover">
                                <img src="img/insta/backery-instagram-05.jpg" class="img-fluid"
