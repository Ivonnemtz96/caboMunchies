...
if (!validarVariable($nombre)|| !validarVariable($email) || !validarVariable($tel) || !validarVariable($msj)) {
  mandarError("1");
}
  ...
  private function primeraParteDelCuerpo()
  {
    ...
    <html lang="es">
      <head>
        ...
        <title>Los Cabos Munchies</title>
        <style>
                ...
                <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;">
                  <tr>
                    <td class="content-block" style="font-family: sans-serif; vertical-align: top; padding-bottom: 10px; padding-top: 10px; font-size: 12px; color: #999999; text-align: center;">
                      <span class="apple-link" style="color: #999999; font-size: 12px; text-align: center;">Copyright © 2024 Los Cabos Munchies. Todos los Derechos Reservados.</span>
                      <br>Los Cabos, B.C.S. México.
                    </td>
                  </tr>
                  <tr>
                    <td class="content-block powered-by" style="font-family: sans-serif; vertical-align: top; padding-bottom: 10px; padding-top: 10px; font-size: 12px; color: #999999; text-align: center;">
                      Powered by <a href="https://bananagroup.mx" style="color: #999999; font-size: 12px; text-align: center; text-decoration: none;"><strong>Banana Group Marketing</strong>.</a>
                    </td>
                  </tr>
                </table>
              </div>
